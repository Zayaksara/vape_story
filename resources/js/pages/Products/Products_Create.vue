        ...
        <form @submit.prevent="submit" class="bg-white rounded shadow p-6 space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input v-model="form.code" type="text" placeholder="contoh: VPE-001"
            ...
            <div>
                ...
                <input v-model="form.base_price" type="number" min="0" placeholder="0"
                       class="w-full border rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400"
            ...
            <div class="border rounded p-4 bg-gray-50">
                ...
                <div class="grid grid-cols-3 gap-4">
                    <div>
                        ...
                        <input v-model="form.flavor" type="text" placeholder="Mango Ice"
                               class="w-full border rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400" />
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-gray-600 mb-1">Ukuran (ml)</label>
                        <input v-model="form.size_ml" type="number" min="0" placeholder="30"
                               class="w-full border rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400" />
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-gray-600 mb-1">Nikotin (mg)</label>
                        <input v-model="form.nicotine_strength" type="number" min="0" placeholder="3"
                               class="w-full border rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400" />
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <textarea v-model="form.description" rows="3" placeholder="Deskripsi produk..."
